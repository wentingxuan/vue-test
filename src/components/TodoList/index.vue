...
{ text: '吾日七省吾身', done: false },
  { text: 'learn Vue            (学习Vue了吗？)', done: false },
  { text: 'updated the project  (更新项目了吗？)', done: false },
  { text: 'learn gitchat lesson (gitchat的课程看了吗？)', done: false },
  { text: 'use and learn        (学到新东西了吗？)', done: false },
  { text: 'Speak patiently      (对别人说话耐心吗？)', done: false },
  { text: 'Talk to parents      (和父母聊天了吗？)', done: false },
  { text: 'Look at children        (看小宝宝了吗？)', done: false },
]
export default {
  components: { Todo },
  data() {
